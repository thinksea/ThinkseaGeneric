...
(function (Thinksea) {
    ...
    (function (Net) {
        ...
        (function (FileUploader) {
                ...
                getCheckCode(file) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        reader.onload = function (e) {
                            return __awaiter(this, void 0, void 0, function* () {
                                pos = end;
                                sha1Instance.update(Thinksea.Net.FileUploader.HttpFileUploadAsync.arrayBufferToWordArray(e.target.result));
                                if (pos < file.size) {
                                    yield progressiveReadNext();
                                }
                                else {
                                    let sha1Value = sha1Instance.finalize();
                                    _self.checkCode = sha1Value.toString().toUpperCase();
                                    yield _self.startFastUpload(file);
                                }
                            });
                        };
                        function progressiveReadNext() {
                            ...
                            return __awaiter(this, void 0, void 0, function* () {
                                ...
                                if (ErrorCode == 0) {
                                    ...
                                    if (_self.findBreakpoint && breakpoint !== 0) {
                                        ...
                                        yield _self.findBreakpoint(p);
                                        breakpoint = p.Breakpoint;
                                    }
                                    yield _self.beginUploadFile(file, breakpoint);
                                }
                                else {
                                    if (_self.errorOccurred) {
                                        let e = {
            ...
            FileUploader.HttpFileUploadAsync = HttpFileUploadAsync;
