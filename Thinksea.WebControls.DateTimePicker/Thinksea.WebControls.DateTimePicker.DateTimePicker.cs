...
//			}
		...
		protected override void OnPreRender(EventArgs e)
		{
            ...
            this.Controls.Add(new System.Web.UI.LiteralControl("<script type=\"text/javascript\" language=\"javascript\">DateTimePicker_DrawCalendar(\"" + this.ClientID + "\", " + this.DateTime.Year.ToString() + ",  " + this.DateTime.Month.ToString() + ",  " + this.DateTime.Day.ToString() + ",  " + this.DateTime.Hour.ToString() + ",  " + this.DateTime.Minute.ToString() + ",  " + this.DateTime.Second.ToString() + ", \"" + imageUrl + "\", " + this.ReadOnly.ToString().ToLowerInvariant() + ", " + this.Enabled.ToString().ToLowerInvariant() + ", " + this.ShowDate.ToString().ToLowerInvariant() + ", " + this.ShowHour.ToString().ToLowerInvariant() + ", " + this.ShowMinute.ToString().ToLowerInvariant() + ", " + this.ShowSecond.ToString().ToLowerInvariant() + ", " + this.ShowDataSelector.ToString().ToLowerInvariant() + ", \"" + DateTimePickerUpImage + "\", \"" + DateTimePickerDownImage + "\");</script>"));
